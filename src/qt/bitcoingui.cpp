    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Agni Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Agni address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and agni: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Agni Core"), this);
    aboutAction->setStatusTip(tr("Show information about Agni Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Agni Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Agni addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Agni addresses"));
    ...
    openAction->setStatusTip(tr("Open a agni: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Agni Core help message to get a list with possible Agni Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Agni Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Agni network", "", count));
    } else {
...
{
    QString strTitle = tr("Agni Core"); // default title
