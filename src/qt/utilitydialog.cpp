    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Agni Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Agni Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  agni-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Agni in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 AGNI, 0.1 AGNI, 1 AGNI and 10 AGNI -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://agnicoin.tech/wiki/display/DOC/PrivateSend\">https://agnicoin.tech/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Agni Core is shutting down...") + "<br /><br />" +
