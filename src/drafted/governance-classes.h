 ...
 *
 *   // network
 *   CAgniNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.agnicoin.tech/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CAgniNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: AgniNetwork
// //   -- signature requirements : Key1(User)
// class CAgniNetworkVariable : public CGovernanceObject
// {
// private:
