...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 AGNI:
        ...
        # First: use raw transaction API to send 12400 AGNI to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 500 AGNI coin each
        ...
        # Node0's balance should be starting balance, plus 500AGNI for another
        ...
        # Node0's total balance should be starting balance, plus 1000AGNI for
