...
This mechanism has been integrated into Bitcore-Node-Agni which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/agnicoin/insight-api-agni#web-socket-api](https://github.com/agnicoin/insight-api-agni#web-socket-api)
* API: [https://github.com/agnicoin/insight-api-agni#instantsend-transactions](https://github.com/agnicoin/insight-api-agni#instantsend-transactions)
...
By default, the Agni Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Agni Core daemon:
